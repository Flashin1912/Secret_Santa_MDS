...
namespace WindowsFormsApp1
{
    public partial class Camera_final : Form
    {
        ...
        static string GetRandomTerm(string input)
        {
            ...
            // Returnăm termenul selectat
            return terms[randomIndex];
        }
        public Camera_final()
        {
            InitializeComponent();
            string input = "Dovlecel Maria; Floricica Dansatoare; Hanna John; Klaus Dahmer; Ursut Grigore";
            string term1 = GetRandomTerm(input);
            string detalii = "Robot; Jucarie; Trenulet; Masina de pe Rocket League(Fennec); Prestige K/DA Kai'sa";
            string term2 = GetRandomTerm(detalii);
            Nume_spiridus.Text = term1 + Environment.NewLine + "Care doreste:" + term2;
        }
